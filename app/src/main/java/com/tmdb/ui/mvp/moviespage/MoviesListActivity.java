                        ...
                        switch (item.getItemId()) {
                            case R.id.bn_movie_latest:
                                fragment = getSupportFragmentManager()
                                        .findFragmentByTag(RELEASE_DATE_TAG);
                                if (fragment == null) {
                                ...
                                FragmentTransaction transaction = getSupportFragmentManager()
                                        .beginTransaction();
                                transaction
                                        .replace(R.id.moviesFrameLayout, fragment, RELEASE_DATE_TAG)
                                        .commit();
                                break;
                            case R.id.bn_movie_popular:
                                fragment = getSupportFragmentManager()
                                        .findFragmentByTag(POPULAR_TAG);
                                if (fragment == null) {
                                ...
                                getSupportFragmentManager().beginTransaction()
                                        .replace(R.id.moviesFrameLayout, fragment, POPULAR_TAG)
                                        .commit();
                                break;
                            case R.id.bn_movie_vote_count:
                                fragment = getSupportFragmentManager()
                                        .findFragmentByTag(VOTE_COUNT_TAG);
                                if (fragment == null) {
                                    fragment = MoviesFragment.newInstance();
                                ...
                                getSupportFragmentManager().beginTransaction()
                                        .replace(R.id.moviesFrameLayout, fragment, VOTE_COUNT_TAG)
                                        .commit();
                                break;
                            case R.id.bn_movie_favorites:
                                ...
                                getSupportFragmentManager().beginTransaction()
                                        .replace(R.id.moviesFrameLayout, fragment, FAVORITE_TAG)
                                        .commit();
                        }
                        return true;
                    }
